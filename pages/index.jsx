    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          {user && user.sub ? (<code className={styles.code}>Welcome, {user.email}</code>) : (<code className={styles.code}>Please log in</code>)}
          <br></br>
          <span>SSR Authenticated {authenticated ? "Yes" : "No"}</span>
        </p>

        <div className={styles.grid}>
          <button className={styles.card} onClick={() => signUp()}>
            <h2>SignUp</h2>
          </button>
